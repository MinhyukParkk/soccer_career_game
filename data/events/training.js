    ...
    choices: [
      {
        ...
        resultText: "You spent the day with fans and press — good for morale, if nothing else.",
      },
      {
        id: "skip_focus_training",
        label: "Skip it and train instead",
        effects: { "stats.stamina": 2 },
        resultText: "You skipped it and trained instead, picking up a little conditioning work.",
      },
    ],
  },
  {
    ...
    choices: [
      {
        ...
        outcomes: [
          ...
          },
          {
            ...
            label: "Injury",
            positive: false,
            effects: { "stats.stamina": -5, "condition.injuryRiskModifier": 15 },
